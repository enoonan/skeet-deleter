defmodule SkeetDeleterWeb.Router do
  use SkeetDeleterWeb, :router
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {SkeetDeleterWeb.Layouts, :root}
  ...
  scope "/", SkeetDeleterWeb do
    ...
    ash_authentication_live_session :authenticated_routes do
      ...
      # on_mount {SkeetDeleterWeb.LiveUserAuth, :live_user_required}
      #
      # If an authenticated user *may* be present:
      # on_mount {SkeetDeleterWeb.LiveUserAuth, :live_user_optional}
      #
  ...
  if Application.compile_env(:skeet_deleter, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: SkeetDeleterWeb.Telemetry
