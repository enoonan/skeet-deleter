defmodule SkeetDeleterWeb.Components.Banner do
  @moduledoc """
  SkeetDeleterWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
