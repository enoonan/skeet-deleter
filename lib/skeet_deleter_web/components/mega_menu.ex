defmodule SkeetDeleterWeb.Components.MegaMenu do
  @moduledoc """
  The `SkeetDeleterWeb.Components.MegaMenu` module provides a customizable and interactive mega menu component
