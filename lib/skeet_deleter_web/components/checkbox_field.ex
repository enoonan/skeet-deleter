defmodule SkeetDeleterWeb.Components.CheckboxField do
  @moduledoc """
  SkeetDeleterWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
