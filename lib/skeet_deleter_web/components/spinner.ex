defmodule SkeetDeleterWeb.Components.Spinner do
  @moduledoc """
  The `SkeetDeleterWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `SkeetDeleterWeb.Components.Spinner` module enables developers to provide
