defmodule SkeetDeleterWeb.Components.Divider do
  @moduledoc """
  The `SkeetDeleterWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  @doc """
  `SkeetDeleterWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
