defmodule SkeetDeleterWeb.Components.ScrollArea do
  @moduledoc """
  The `SkeetDeleterWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
