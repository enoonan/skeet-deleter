defmodule SkeetDeleterWeb.Components.TableContent do
  @moduledoc """
  `SkeetDeleterWeb.Components.TableContent` is a component module designed to create flexible and dynamic
