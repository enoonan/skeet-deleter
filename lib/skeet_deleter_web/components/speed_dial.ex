defmodule SkeetDeleterWeb.Components.SpeedDial do
  @moduledoc """
  The `SkeetDeleterWeb.Components.SpeedDial` module provides a versatile speed dial component for Phoenix
