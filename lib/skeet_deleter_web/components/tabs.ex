defmodule SkeetDeleterWeb.Components.Tabs do
  @moduledoc """
  `SkeetDeleterWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import SkeetDeleterWeb.Components.Badge, only: [badge: 1]
