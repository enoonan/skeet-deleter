defmodule SkeetDeleterWeb.Components.Indicator do
  @moduledoc """
  The `SkeetDeleterWeb.Components.Indicator` module provides a versatile component for visually highlighting
