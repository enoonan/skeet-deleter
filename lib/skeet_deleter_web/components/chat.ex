defmodule SkeetDeleterWeb.Components.Chat do
  @moduledoc """
  `SkeetDeleterWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
