defmodule SkeetDeleterWeb.Components.Overlay do
  @moduledoc """
  The `SkeetDeleterWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `SkeetDeleterWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
