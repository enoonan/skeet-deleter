defmodule SkeetDeleterWeb.Components.Menu do
  @moduledoc """
  The `SkeetDeleterWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `SkeetDeleterWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import SkeetDeleterWeb.Components.Accordion, only: [accordion: 1]
  import SkeetDeleterWeb.Components.Button, only: [button_link: 1]
