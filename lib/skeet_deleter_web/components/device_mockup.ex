defmodule SkeetDeleterWeb.Components.DeviceMockup do
  @moduledoc """
  The `SkeetDeleterWeb.Components.DeviceMockup` module provides a customizable component for displaying
