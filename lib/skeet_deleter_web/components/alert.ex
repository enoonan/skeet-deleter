defmodule SkeetDeleterWeb.Components.Alert do
  @moduledoc """
  SkeetDeleterWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
