defmodule SkeetDeleterWeb.Components.CheckboxCard do
  @moduledoc """
  The `SkeetDeleterWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
