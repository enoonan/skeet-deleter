defmodule SkeetDeleterWeb.Components.RadioCard do
  @moduledoc """
  The `SkeetDeleterWeb.Components.RadioCard` module provides a customizable radio card component for Phoenix LiveView
