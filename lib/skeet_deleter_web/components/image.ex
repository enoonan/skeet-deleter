defmodule SkeetDeleterWeb.Components.Image do
  @moduledoc """
  The `SkeetDeleterWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
