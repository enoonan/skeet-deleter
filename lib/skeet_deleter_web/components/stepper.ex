defmodule SkeetDeleterWeb.Components.Stepper do
  @moduledoc """
  The `SkeetDeleterWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `SkeetDeleterWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
