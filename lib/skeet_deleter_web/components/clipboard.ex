defmodule SkeetDeleterWeb.Components.Clipboard do
  @moduledoc """
  The `SkeetDeleterWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
