defmodule SkeetDeleterWeb.Components.FileField do
  @moduledoc """
  The `SkeetDeleterWeb.Components.FileField` module provides a versatile and customizable component
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SkeetDeleterWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SkeetDeleterWeb.Gettext, "errors", msg, opts)
    end
  end
end
